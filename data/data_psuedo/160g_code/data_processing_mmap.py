...
def overlap(s1, s2, metric = 'efd', debug = False, tokenizer = None): # s1 short s2 long
    ...
    if metric == 'rouge1':
        ...
        ol = 2 * rgs['rouge2'][0].fmeasure + rgs['rouge1'][0].fmeasure 
    elif metric == 'efd':
...
parser.add_argument('--datas_prefix', type=str, default='wiki1')
parser.add_argument('--output_path', type=str, default='./output/from_wiki1/')
