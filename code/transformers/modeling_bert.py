...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        super().__init__()
        # print('config.pad_token_id',config.pad_token_id,type(config.pad_token_id))
        self.word_embeddings = nn.Embedding(config.vocab_size, config.hidden_size, padding_idx=config.pad_token_id)
        self.position_embeddings = nn.Embedding(config.max_position_embeddings, config.hidden_size)
        self.token_type_embeddings = nn.Embedding(config.type_vocab_size, config.hidden_size)
        # self.speaker_embeddings = nn.Embedding(22, config.hidden_size, padding_idx=0)
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        # print('inputs_embeddings:', inputs_embeds)
        # print("speaker_embeddings:",speaker_embeddings)
