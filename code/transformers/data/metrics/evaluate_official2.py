...
def get_raw_scores(dataset, preds):
    ...
    for article in dataset['dialogues']:
        ...
        for qa in article['qas']:
            ...
            if not gold_answers:
                # For unanswerable questions, only correct answer is empty string ->plausible answers
                gold_answers = [a['text'] for a in qa['plausible_answers'] if normalize_answer(a['text'])]
            if qid not in preds:
