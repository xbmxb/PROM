...
# from .modeling_pointer import BartForConditionalGeneration_Pointer
...
MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING = OrderedDict(
    [
        ...
        (BartConfig, BartForConditionalGeneration),
        # (BartConfig, BartForConditionalGeneration_Pointer),
        (FSMTConfig, FSMTForConditionalGeneration),
        (EncoderDecoderConfig, EncoderDecoderModel),
...
MODEL_FOR_QUESTION_ANSWERING_MAPPING = OrderedDict(
    [
        ...
        (RobertaConfig, RobertaForQuestionAnswering), #done
        (SqueezeBertConfig, SqueezeBertForQuestionAnswering),
        (BertConfig, BertForQuestionAnswering), #done
        (XLNetConfig, XLNetForQuestionAnsweringSimple),
        (FlaubertConfig, FlaubertForQuestionAnsweringSimple),
        (MobileBertConfig, MobileBertForQuestionAnswering),
        (XLMConfig, XLMForQuestionAnsweringSimple),
        (ElectraConfig, ElectraForQuestionAnswering), #done
