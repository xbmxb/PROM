...
class ElectraEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        # self.speaker_embeddings = nn.Embedding(22, config.embedding_size, padding_idx=0)
        # print('config.embedding/hidden_size:',config.embedding_size, config.hidden_size)
