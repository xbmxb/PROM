...
class GenerationMixin:
    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs
        ...
        if is_encoder_decoder:
            ...
            encoder_outputs["encoder_input_ids"] = encoder_outputs.encoder_input_ids.index_select(
                0, expanded_return_idx
            )
    ...
    def generate(
        ...
        **model_kwargs
        ...
        if self.config.is_encoder_decoder:
            ...
            encoder_input_ids = input_ids # save encoder inputs
        ...
        if is_greedy_gen_mode:
            ...
            if copylabels is not None:
                copylabels, _ = self._expand_inputs_for_generation(
                    copylabels, expand_size=num_beams
                )
    ...
    def beam_search(
        ...
        **model_kwargs
        ...
        while cur_len < max_length:
            model_inputs = self.prepare_inputs_for_generation(encoder_input_ids, input_ids, copylabels=copylabels, **model_kwargs)

            outputs, cp_loss = self(**model_inputs, return_dict=True)
            next_token_logits = outputs.logits[:, -1, :]
